    ...
    return (
        <div className='bg-gray-200 px-5 py-10 grid lg:grid-cols-3'>
            <div className='px-5 pt-10 my-5  bg-white rounded-3xl lg:px-10 md:mx-5  hover:bg-gray-700 hover:text-slate-300'>
                <p className='text-center sm:text-start lg:text-center text-2xl font-semibold pb-3 px-5'>Free Trial Limited features</p>
                <div className='flex py-2 '>
                    ...
                    <p >For serverless applications with variable or infrequen</p>
                </div>
                <div className='flex py-2'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        strokeWidth={1.5}
