...
function SuperUserLogin() {
  ...
  const handleLogin=useLogin(handleLoginApi,setSuperUserLogedIn,'superUserToken',"/superUser/dashboard")
  return (
    <div>
      <CommonForm
        formName="Super User"
        ...
        fieldArray={[
          ...
          { field: "password", required: true, type: "password", validation: /^(?=.*[!@#$%^&*()\-_=+{}[\]|;:'",.<>/?])(?=.*[0-9])(?=.*[a-zA-Z]).*$/, placeHolder: 'Enter password' },
        ]}
